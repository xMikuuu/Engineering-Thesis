...
public class DefensiveStance : MonoBehaviour
{
    ...
    void Update(){
        ...
        if(PlayerActions.defensivestanceClickable==true){
    ...
    void OnMouseOver()
    {
        actionInfo.text = "Block X% of\ndamage";
        actionDetails.text = Actions.defensiveStanceProcent.ToString();
